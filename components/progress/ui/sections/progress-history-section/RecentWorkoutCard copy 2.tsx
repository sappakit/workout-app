...
export function RecentMetricList({
  ...
  return (
    <View className={className}>
      <View className="flex-row items-center rounded-lg bg-secondary p-2">
        ...
        <FlatList
          ...
          numColumns={3}
          scrollEnabled={false}
          columnWrapperClassName="items-center gap-2"
...
function RecentMetric({ icon, label, value }: RecentMetricProps) {
  ...
  return (
    <View className="flex-1 flex-row items-center justify-center gap-3 py-3">
